...
public class LoginActivity extends AppCompatActivity {
    ...
    private String url_login = "https://heavymetals.scarlet2.io/HeavyMetals/login_user.php"; // Ensure this is correct
    ...
    private void authenticateUser(String email, String password) {
        ...
        // Add your request to the RequestQueue
    ...
    public void onErrorResponse(VolleyError error) {
        ...
        Toast.makeText(LoginActivity.this, "Network error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
        error.printStackTrace(); // For detailed logs
    }
}
